...
class GuiReadFiles(wx.Panel):
    def __init__(self, parent):
        ...
        main_sizer = wx.FlexGridSizer(cols=2, vgap=5, hgap=5)
        ...
        main_sizer.Add(button_opendir, 0, wx.ALL)
        ...
        hsizer = wx.BoxSizer(wx.HORIZONTAL)
        main_sizer.Add(button_opencoois)
        self.txt_coois = wx.TextCtrl(self)
        self.txt_coois.Bind(wx.EVT_COMMAND_LEFT_CLICK, parent.on_open_coois)
        main_sizer.Add(self.txt_coois, 0, wx.ALL)
        # main_sizer.Add(hsizer)
